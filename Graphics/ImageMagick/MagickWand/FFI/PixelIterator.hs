{-# LINE 1 "Graphics/ImageMagick/MagickWand/FFI/PixelIterator.hsc" #-}
{-# LANGUAGE CPP, ForeignFunctionInterface #-}
{-# LINE 2 "Graphics/ImageMagick/MagickWand/FFI/PixelIterator.hsc" #-}
...
{-# LINE 13 "Graphics/ImageMagick/MagickWand/FFI/PixelIterator.hsc" #-}
